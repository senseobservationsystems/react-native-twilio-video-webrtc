...
NiceDay fork of [react-native-twilio-video-webrtc](blackuy/react-native-twilio-video-webrtc) used in [goalie-2-mobile-app](senseobservationsystems/goalie-2-mobile-app).
...
- [In `goalie-2-mobile-app`] Track [issues](senseobservationsystems/goalie-2-mobile-app/issues)
...
- [In this repo] [Create a new release](senseobservationsystems/react-native-twilio-video-webrtc/releases/new) targeting `niceday-master` with the next semantic version (e.g. `v1.1.0`)
...
_Upstream (blackuy) README.md continues below…_
